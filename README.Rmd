...
The goal of `LymphomaSubtype` is to provide an user with an easy breakdown of each subtypes of lymphoma. The data is based on https://www.llscanada.org/lymphoma/non-hodgkin-lymphoma/diagnosis/nhl-subtypes and https://www.lymphomacoalition.org/lymphomas/lymphoma-subtypes as of Nov 16th, 2020.
